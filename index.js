...
//! Строгое равенство ( ===) является аналогом оператора равенства ( == ). Но их отличие в том что строгое неравенство не осуществляет преобразование типов,
...
// есть массив с идентификаторами и названиями фильмов 
const titles = films.map((film) => {
    return film.title;
});
// перебираем массив и говорим чтобы map добавил в созданный собой массив значение title массива films
...
// Задача на возвращение обратного числа 
...
// Перевод входной смтроки в camelCase
